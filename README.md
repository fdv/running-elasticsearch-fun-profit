...
- [Designing the Perfect Elasticsearch Cluster](003-cluster-design/003-cluster-design.md/#designing-the-perfect-elasticsearch-cluster)
  * [Elasticsearch is elastic, for real](003-cluster-design/003-cluster-design.md/#elasticsearch-is-elastic--for-real)
  * [Design for failure](003-cluster-design/003-cluster-design.md/#design-for-failure)
  * [A few things you need to know about Lucene](003-cluster-design/003-cluster-design.md/#a-few-things-you-need-to-know-about-lucene)
    + [Lucene segments](003-cluster-design/003-cluster-design.md/#lucene-segments)
    + [Lucene deletes and updates](003-cluster-design/003-cluster-design.md/#lucene-deletes-and-updates)
  * [Hardware](003-cluster-design/003-cluster-design.md/#hardware)
    + [CPU](003-cluster-design/003-cluster-design.md/#cpu)
    + [Memory](003-cluster-design/003-cluster-design.md/#memory)
    + [Network](003-cluster-design/003-cluster-design.md/#network)
    + [Storage](003-cluster-design/003-cluster-design.md/#storage)
  * [Software](003-cluster-design/003-cluster-design.md/#software)
    + [The Linux (003-cluster-design/003-cluster-design.md//or FreeBSD) kernel](003-cluster-design/003-cluster-design.md/#the-linux--or-freebsd--kernel)
    + [The Java Virtual Machine](003-cluster-design/003-cluster-design.md/#the-java-virtual-machine)
    + [The filesystem](003-cluster-design/003-cluster-design.md/#the-filesystem)
  * [Designing your indices](003-cluster-design/003-cluster-design.md/#designing-your-indices)
    + [Sharding](003-cluster-design/003-cluster-design.md/#sharding)
    + [Replication](003-cluster-design/003-cluster-design.md/#replication)
  * [Optimising allocation](003-cluster-design/003-cluster-design.md/#optimising-allocation)
  * [Troubleshooting and scaling](003-cluster-design/003-cluster-design.md/#troubleshooting-and-scaling)
    + [CPU](003-cluster-design/003-cluster-design.md/#cpu-1)
    + [Memory](003-cluster-design/003-cluster-design.md/#memory-1)

- [Design for Event Logging](004-design-event-logging/004-design-event-logging.md/#design-for-event-logging)
  * [Design of an event logging infrastructure cluster](004-design-event-logging/004-design-event-logging.md/#design-of-an-event-logging-infrastructure-cluster)
    + [Throughput: how many events per second (004-design-event-logging/004-design-event-logging.md//eps) are you going to collect?](004-design-event-logging/004-design-event-logging.md/#throughput--how-many-events-per-second--eps--are-you-going-to-collect-)
    + [Retention: how long do you want to keep your data, hot and cold?](004-design-event-logging/004-design-event-logging.md/#retention--how-long-do-you-want-to-keep-your-data--hot-and-cold-)
    + [Size: what is the average size of a collected event?](004-design-event-logging/004-design-event-logging.md/#size--what-is-the-average-size-of-a-collected-event-)
    + [Fault tolerance: can you afford losing your indexed data?](004-design-event-logging/004-design-event-logging.md/#fault-tolerance--can-you-afford-losing-your-indexed-data-)
    + [Queries](004-design-event-logging/004-design-event-logging.md/#queries)
  * [Which hardware do I need?](004-design-event-logging/004-design-event-logging.md/#which-hardware-do-i-need-)
  * [How to design my indices?](004-design-event-logging/004-design-event-logging.md/#how-to-design-my-indices-)
  * [What about some tuning?](004-design-event-logging/004-design-event-logging.md/#what-about-some-tuning-)

- [Operating Daily](005-operating-daily/005-operating-daily.md/#operating-daily)
  * [Elasticsearch most common operations](005-operating-daily/005-operating-daily.md/#elasticsearch-most-common-operations)
    + [Mass index deletion with pattern](005-operating-daily/005-operating-daily.md/#mass-index-deletion-with-pattern)
    + [Mass optimize, indexes with the most deleted docs first](005-operating-daily/005-operating-daily.md/#mass-optimize--indexes-with-the-most-deleted-docs-first)
    + [Restart a cluster using rack awareness](005-operating-daily/005-operating-daily.md/#restart-a-cluster-using-rack-awareness)
    + [Optimize your cluster restart](005-operating-daily/005-operating-daily.md/#optimize-your-cluster-restart)
    + [Remove data nodes from a cluster the safe way](005-operating-daily/005-operating-daily.md/#remove-data-nodes-from-a-cluster-the-safe-way)
  * [Get useful information about your cluster](005-operating-daily/005-operating-daily.md/#get-useful-information-about-your-cluster)
    + [Nodes information](005-operating-daily/005-operating-daily.md/#nodes-information)
    + [Monitor your search queues](005-operating-daily/005-operating-daily.md/#monitor-your-search-queues)
    + [Indices information](005-operating-daily/005-operating-daily.md/#indices-information)
    + [Shard allocation information](005-operating-daily/005-operating-daily.md/#shard-allocation-information)
    + [Recovery information](005-operating-daily/005-operating-daily.md/#recovery-information)
    + [Segments information (005-operating-daily/005-operating-daily.md//can be extremely verbose)](005-operating-daily/005-operating-daily.md/#segments-information--can-be-extremely-verbose-)
    + [Cluster stats](005-operating-daily/005-operating-daily.md/#cluster-stats)
    + [Nodes stats](005-operating-daily/005-operating-daily.md/#nodes-stats)
    + [Indice stats](005-operating-daily/005-operating-daily.md/#indice-stats)
    + [Indice mapping](005-operating-daily/005-operating-daily.md/#indice-mapping)
    + [Indice settings](005-operating-daily/005-operating-daily.md/#indice-settings)
    + [Cluster dynamic settings](005-operating-daily/005-operating-daily.md/#cluster-dynamic-settings)
    + [All the cluster settings (005-operating-daily/005-operating-daily.md//can be extremely verbose)](005-operating-daily/005-operating-daily.md/#all-the-cluster-settings--can-be-extremely-verbose-)


- [Monitoring Elasticsearch](006-monitoring-es/006-monitoring-es.md/#monitoring-elasticsearch)
  * [Tools](006-monitoring-es/006-monitoring-es.md/#tools)
  * [Monitoring at the host level](006-monitoring-es/006-monitoring-es.md/#monitoring-at-the-host-level)
  * [Monitoring at the node level](006-monitoring-es/006-monitoring-es.md/#monitoring-at-the-node-level)
  * [Monitoring at the cluster level](006-monitoring-es/006-monitoring-es.md/#monitoring-at-the-cluster-level)
  * [Monitoring at the index level](006-monitoring-es/006-monitoring-es.md/#monitoring-at-the-index-level)
